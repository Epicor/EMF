...
__ep_build_info["menu"] = {"libName":"menu","version":"1.0.10-dev.474","built":"2017-01-29"};
...
(function() {
    ...
    angular.module('ep.list').filter('fromNow', function() {

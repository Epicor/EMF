...
__ep_build_info["menu"] = {"libName":"menu","version":"1.0.14-dev.246","built":"2017-10-08"};
...
(function() {
    ...
    angular.module('ep.multi.level.menu').controller('epMultiLevelMenuCtrl',
        ...
        ['$rootScope', '$scope', '$timeout', 'epMultiLevelMenuFactory', 'epMultiLevelMenuConstants', 'epMultiLevelMenuService', function($rootScope, $scope, $timeout, epMultiLevelMenuFactory, epMultiLevelMenuConstants,
             ...
             */
            function navigateAlternate(mi, event) {
                if (!mi) {
                    return;
                }
            ...
            $scope.navigateAlternate = navigateAlternate;
        ...
        return {
            ...
            link: function(scope) {
                ...
                scope.initData = function() {
                    ...
                    origListData = angular.extend([], scope.listData);
                    ...
                    if (searchValue) {
                        ...
                        if (firstLetter !== scope.prevFirstLetter) {
                            ...
                            if (!scope.selectedDirectoryEntry) {
                                ...
                                scope.filteredData = origListData.slice(
                ...
                function applyStrDateSearchFilter(searchValue) {
                    ...
                    if (searchValue) {
                        var year = NaN;
                        if (searchValue.length === 4 && searchValue.indexOf('-') < 0) {
                            //search by year
                        ...
                        if (!isNaN(year)) {
                            ...
                            if (groups.length) {
                                ...
                                angular.forEach(groups, function(group) {
                                    filteredData =
                                        filteredData.concat(origListData.slice(group.index, group.nextIndex));
                                });
                            }
                            filtered = true;
                            ...
                            if (directoryEntry) {
                                ...
                                filtered = true;
                                scope.filteredData = origListData.slice(directoryEntry.index,
                ...
                scope.goToDirectory = function(directoryEntry) {
                    ...
                    scope.filteredData = origListData.slice(directoryEntry.index, directoryEntry.nextIndex);
                    scope.selectedDirectoryEntry = directoryEntry;
                    scope.filtered = true;
                    scope.searchFilter = '';
